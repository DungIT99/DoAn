...
<!-- Mirrored from pixelgeeklab.com/html/flatize/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 May 2019 07:52:00 GMT -->
<head>
	<meta charset="utf-8">
			...
			<nav class="navbar navbar-default navbar-main navbar-main-slide" role="navigation">
				<div class="container">
					...
					<ul class="nav navbar-nav navbar-act pull-right">
						<li class="login"><a href="#modal-id" data-toggle="modal"><i class="fa fa-user"></i></a></li>
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav pull-right">
							...
							<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">S?n ph?m</a>
								<ul class="dropdown-menu">
									<li class="dropdown-submenu">
										<a href="#">Th?i trang nam</a>
										<ul class="dropdown-menu">
		...
		<div role="main" class="main">
			...
			<section class="main-slide">
				<div id="owl-main-demo" class="owl-carousel main-demo">
					<div class="item" id="item1"><img src="public/images/content/slides/slider1.jpg" class="img-responsive" alt="Photo">
					...
					<div class="item" id="item2"><img src="public/images/content/slides/slider2.jpg" class="img-responsive" alt="Photo">
						<div class="item-caption">
							<div class="item-caption-inner">
								<div class="item-caption-wrap">
					...
					<div class="item" id="item3"><img src="public/images/content/slides/slider3.jpg" class="img-responsive" alt="Photo">
						<div class="item-caption">
							<div class="item-caption-inner">
								<div class="item-caption-wrap">
								...
								<div class="item product">
									<div class="product-thumb-info">
										<div class="product-thumb-info-image">
											...
											<img alt="" class="img-responsive" src="public/images/content/products/product-4.jpg">
										</div>
										<div class="product-thumb-info-content">
								...
								<div class="item product">
									...
									<div class="product-thumb-info">
										<div class="product-thumb-info-image">
											...
											<img alt="" class="img-responsive" src="public/images/content/products/product-5.jpg">
										</div>
										<div class="product-thumb-info-content">
						...
						<div class="col-sm-6">
							<div class="product-preview">
								<ul class="bxslider" id="slider1">
									<li><img alt="" class="img-responsive" src="public/images/content/products/product-1.jpg"></li>
									<li><img alt="" class="img-responsive" src="public/images/content/products/product-1-1.jpg"></li>
									<li><img alt="" class="img-responsive" src="public/images/content/products/product-1-2.jpg"></li>
									<li><img alt="" class="img-responsive" src="public/images/content/products/product-1-3.jpg"></li>
									<li><img alt="" class="img-responsive" src="public/images/content/products/product-1-4.jpg"></li>
								</ul>

								<ul class="list-inline bx-pager">
									<li><a data-slide-index="0" href="#"><img alt="" class="img-responsive" src="public/images/content/products/product-thumb.jpg"></a></li>
									<li><a data-slide-index="1" href="#"><img alt="" class="img-responsive" src="public/images/content/products/product-thumb-1.jpg"></a></li>
									<li><a data-slide-index="2" href="#"><img alt="" class="img-responsive" src="public/images/content/products/product-thumb-2.jpg"></a></li>
									<li><a data-slide-index="3" href="#"><img alt="" class="img-responsive" src="public/images/content/products/product-thumb-3.jpg"></a></li>
									<li><a data-slide-index="4" href="#"><img alt="" class="img-responsive" src="public/images/content/products/product-thumb-4.jpg"></a></li>
								</ul>
							</div>
						</div>
						<div class="col-sm-6">
